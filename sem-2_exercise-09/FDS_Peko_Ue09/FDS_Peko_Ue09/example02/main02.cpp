...
void get_cpu_info() {
    ...
    if (GlobalMemoryStatusEx(&mem_info)) {
        std::cout << "Total Physical Memory: " << (mem_info.ullTotalPhys / (1024 * 1024)) << " MB" << std::endl;
        std::cout << "Available Physical Memory: " << (mem_info.ullAvailPhys / (1024 * 1024)) << " MB" << std::endl;
    }
...
int main() {
    try {
        ...
        std::cout << "- binary_search_analysis.csv" << std::endl;
