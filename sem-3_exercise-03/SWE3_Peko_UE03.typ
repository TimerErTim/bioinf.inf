...
#figure(
  box(stroke: black, inset: 10pt, visualize_gcd_steps_needed(
    range(128),
    range(128),
  )),
...
#figure(
  box(stroke: black, inset: 10pt, visualize_gcd_results(
    range(128),
    range(128),
  )),
...
#figure(
  box(stroke: black, inset: 10pt, visualize_gcd_divergence_distribution(
    range(32 + 1),
    range(32 + 1),
  )),
...
#figure(
  box(stroke: black, inset: 10pt, visualize_gcd_complexity(range(2, 512))),
